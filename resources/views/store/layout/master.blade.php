...
<head>
  ...
  <title>{{ __('store.app_name') }}| @yield('Broser')</title>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <i class="fas fa-users mr-2"></i> {{$notifications->data['title']}}
            <span class="float-right text-muted text-sm">{{$notifications->created_at->diffForHumans()}}</span>
          </a>
          <div class="dropdown-divider"></div>
          @endforeach
          <a href="{{route('user.notification')}}" class="dropdown-item">See All Notifications
          </a>
          <div class="dropdown-divider"></div>
